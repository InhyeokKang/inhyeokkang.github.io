...
- "Fast Coordinator Discovery in IEEE 802.15.4 DSME via Multi-Channel Beaconing and Early-Stop Scanning", **Inhyeok Kang**, Jung-Hyok Kwon, Sol-Bee Lee, Eui-Jik Kim* >> *IEEE Access* (SCIE), under revision.
- "Training-stage Channel State Information Curation Using Activity-specific Quality Index for Human Activity Recognition", Jung-Hyok Kwon, **Inhyeok Kang**, Eui-Jik Kim* >> *IEEE Access* (SCIE), under revision.
